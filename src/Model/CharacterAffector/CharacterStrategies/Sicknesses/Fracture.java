...
public class Fracture implements IBehaviour {
    private ILog log;
    private Strategies name;

    public Fracture() {
        name = Strategies.FRACTURE;
    }
    ...
    public void doSomething(IBoardElement boardElement) {
        ...
        IState state1 = stateFactory.getState(States.IN_PAIN);
        IState state2 = stateFactory.getState(States.IN_PAIN);
        IState state3 = stateFactory.getState(States.INJURED);
